            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.add_student:
                        getSupportFragmentManager().beginTransaction().replace(R.id.container,new AddStudentFragment()).commit();
                        return true;
                    case R.id.timeline:
                        getSupportFragmentManager().beginTransaction().replace(R.id.container,new EditTimeFragment()).commit();
                        return true;
                }
                return false;
            }
